class Reflex < Formula
  ...
  if Hardware::CPU.arm?
    ...
    url "https://github.com/reflex-search/reflex/releases/download/v0.8.0/reflex-search-x86_64-apple-darwin.tar.xz"
    sha256 "7d7b72599c0c80ffb19d9a4ecdecb2f60c0868411b0cd42ad0b30a2e802d0a9f"
  end
